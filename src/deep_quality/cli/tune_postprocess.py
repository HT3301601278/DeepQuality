...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--alphas", help="逗号分隔的 EMA alpha 候选，例如 0.1,0.2,0.5")
    parser.add_argument("--ar-orders", help="逗号分隔的 AR 阶数候选，例如 1,2,3")
    parser.add_argument("--ridge-values", help="逗号分隔的 AR 岭回归系数候选，例如 0,0.01,1")
